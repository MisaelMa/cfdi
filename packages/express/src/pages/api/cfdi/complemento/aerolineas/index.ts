...
import { Aerolineas } from '@cfdi/complementos/4.0/aerolineas';
...
export default async function loginRoute(
  ...
  aerolineas.OtrosCargos({ TotalCargos: '3000' });
  aerolineas.Cargo({ CodigoCargo: '01', Importe: '3000' });
  cfd.complemento(aerolineas);
