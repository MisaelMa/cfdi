...
var NumeroALetras = /** @class */ (function () {
    ...
    // Unidades()
    NumeroALetras.prototype.Decenas = function (num) {
    ...
    // DecenasY()
    NumeroALetras.prototype.DecenasY = function (strSin, numUnidades) {
        if (numUnidades > 0) {
    ...
    // Centenas()
    NumeroALetras.prototype.Centenas = function (num) {
    ...
    // Seccion()
    NumeroALetras.prototype.Seccion = function (num, divisor, strSingular, strPlural) {
    ...
    // Miles()
    NumeroALetras.prototype.Miles = function (num) {
        var divisor = 1000;
        var cientos = Math.floor(num / divisor);
        var resto = num - (cientos * divisor);
    ...
    // Millones()
    NumeroALetras.prototype.Millones = function (num) {
        var divisor = 1000000;
        var cientos = Math.floor(num / divisor);
        var resto = num - (cientos * divisor);
    ...
    NumeroALetras.prototype.NumeroALetras = function (num, curr) {
        var currency = curr || {};
        var data = {
            numero: num,
        ...
        if (data.centavos > 0) {
            if (data.centavos === 1) {
                ...
                // console.log('else '+data.centavos)
